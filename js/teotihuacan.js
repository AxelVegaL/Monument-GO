...
var storeLocationDataUrl = 'Coordenadas/Teotihuacan/TeotihuacanCoor.txt';
...
function initialize() {
    ...
    map = new atlas.Map('myMap', {
        center: [-98.843888888889, 19.6925],
        zoom: 12,
        view: 'Auto',
        ...
        authOptions: {
            ...
            subscriptionKey: 'ZZMWFuPI9sQuRdxqXCoiXVWt3ILmjhOZN2ydJPEoqIM'
        }
    });
